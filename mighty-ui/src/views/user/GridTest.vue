    ...
    <v-content>
      <v-container>
        ...
        <div class='section'>
          ...
          <v-data-table :headers="headers0" :items="desserts" item-key="name" v-model="selected0" select-all>
        ...
        <div class='section'>
          ...
          <v-data-table :headers="headers3" :items="desserts" item-key="name" v-model="selected3" select-all>
        ...
        <div class='section'>
          ...
          <v-data-table :headers="headers5" :items="desserts" item-key="name" group-key="category" v-model="selected5" select-all>
